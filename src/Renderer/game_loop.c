...
// 			if (fps_img->pixels[pixel_index] == 0 && fps_img->pixels[pixel_index
// 				+ 1] == 0 && fps_img->pixels[pixel_index + 2] == 0
// 				&& fps_img->pixels[pixel_index + 3] == 255)
// 			{
